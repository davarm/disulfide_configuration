...
# MOAC Doctoral Training Centre, University of Warwick, UK
#
# See webpage:
...
grid.dir <- "C:/temp/ramachandran/new/top500-angles/pct/rama/"
scatter.filename <- "C:/temp/ramachandran/new/top500-angles/1HMP.tsv"

scatter.data <- load.scatter(scatter.filename)

png(filename="C:/temp/ramachandran/new/1HMP.png",width=410, height=410)
